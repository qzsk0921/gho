 ...
 * Released under the MIT license
 */window.jQuery=window.$=n(0)((o=[n(0)],void(void 0===(r="function"==typeof(i=function(t){var e=/\+/g;function n(t){return o.raw?t:encodeURIComponent(t)}function i(n,i){var r=o.raw?n:function(t){0===t.indexOf('"')&&(t=t.slice(1,-1).replace(/\\"/g,'"').replace(/\\\\/g,"\\"));try{t=decodeURIComponent(t.replace(e," "))}catch(t){return}try{return o.json?JSON.parse(t):t}catch(t){}}(n);return t.isFunction(i)?i(r):r}var o=t.cookie=function(e,r,s){if(void 0!==r&&!t.isFunction(r)){if("number"==typeof(s=t.extend({},o.defaults,s)).expires){var a=s.expires,l=s.expires=new Date;l.setDate(l.getDate()+a)}return document.cookie=[n(e),"=",function(t){return n(o.json?JSON.stringify(t):String(t))}(r),s.expires?"; expires="+s.expires.toUTCString():"",s.path?"; path="+s.path:"",s.domain?"; domain="+s.domain:"",s.secure?"; secure":""].join("")}for(var u,c=e?void 0:{},f=document.cookie?document.cookie.split("; "):[],d=0,p=f.length;d<p;d++){var h=f[d].split("="),g=(u=h.shift(),o.raw?u:decodeURIComponent(u)),v=h.join("=");if(e&&e===g){c=i(v,r);break}e||void 0===(v=i(v))||(c[g]=v)}return c};o.defaults={},t.removeCookie=function(e,n){return void 0!==t.cookie(e)&&(t.cookie(e,"",t.extend({},n,{expires:-1})),!0)}})?i.apply(e,o):i)||(t.exports=r))))},function(t,e,n){n(3),n(2),t.exports=n(1)}]);